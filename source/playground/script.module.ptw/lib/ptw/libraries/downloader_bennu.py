    ...
    def run(self):
        ...
        for item in result:
            ...
            try:
                ...
                print
                '%s ERROR - File Failed To Open' % (dest)
                continue
            ...
            if self.size < 1:
                removeDownload(self.url)
                print
                '%s Unknown filesize - Unable to download' % (dest)
                continue
            ...
            while True:
                ...
                if error:
                    ...
                    count += 1
                    print
                    '%d Error(s) whilst downloading %s' % (count, dest)
                ...
                if (resumable and errors > 0) or errors >= 10:
                    if (not resumable and resume >= 50) or resume >= 500:
                        # Give up!
                        print
                        '%s download canceled - too many error whilst downloading' % (dest)
                        break
                    ...
                    if resumable:
                        ...
                        # create new response
                        print
                        'Download resumed (%d) %s' % (resume, dest)
                        h = headers;
