...
def get(function, duration, *args):
    ...
    try:
        ...
        cache_result = None
        if cache_result:
            # TODO check cache_result['value']
            if _is_cache_valid(cache_result['date'], duration) and cache_result['value'] != '[]':
        ...
        fresh_result = fresh_result.replace("b\\", "\\")
        return ast.literal_eval(fresh_result)
