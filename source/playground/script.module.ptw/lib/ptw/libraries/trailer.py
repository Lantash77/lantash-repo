...
class trailer:
    def __init__(self):
        ...
        self.key_link = control.addon('plugin.video.youtube').getSetting('youtube.api.key')
    ...
    def resolve(self, url):
        try:
            ...
            message = client.parseDOM(result, 'div', attrs={
                'id': 'unavailable-submessage'})
            message = ''.join(message)

            alert = client.parseDOM(result, 'div', attrs={
                'id': 'watch7-notification-area'})
