...
class Search(object):
    ...
    def __init__(self, url=None, pluginUrl=None, service=None, listItemsFun=None, count=None, title=None, argv=None):
        self.url = url
    ...
    def updateHistory(self, select=None):
        ...
        self.saveHistory()
        xbmc.executebuiltin("Container.Refresh")  # select - ignored, I can select item after refresh
