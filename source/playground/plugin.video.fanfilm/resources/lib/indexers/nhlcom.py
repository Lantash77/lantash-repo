        ...
        try:
            ...
            try:
                name = '%s at %s  [COLOR gold](%s)[/COLOR]  [COLOR red](%s)[/COLOR]' % (
                    item['awayTeamName'], item['homeTeamName'], (procTimezone(5, est)).strftime('%H:%M'), (procTimezone(5, est)).strftime('%Y-%m-%d'))
            except:
                name = '%s at %s  [COLOR gold](%s)[/COLOR]  [COLOR red](%s-%s-%s)[/COLOR]' % (item['awayTeamName'], item['homeTeamName'], est[3], est[0], est[1], est[2])
...
def nhlArchives():
    ...
    for item in items:
        try:
            ...
            try:
                name = '%s at %s  [COLOR gold](%s)[/COLOR]  [COLOR red](%s)[/COLOR]' % (item['a'], item['h'], (procTimezone(5, est)).strftime('%H:%M'), (procTimezone(5, est)).strftime('%Y-%m-%d'))
            except:
                name = '%s at %s  [COLOR gold](%s)[/COLOR]  [COLOR red](%s-%s-%s)[/COLOR]' % (item['a'], item['h'], est[3], est[0], est[1], est[2])
...
def nhlStreams(name, url):
    ...
    try:
        l1.append({
            'name': n1 % 'Home LIVE',
            'url': h['live']['bitrate0'] + selectHomeGame,
            'image': image})
    except:
        pass
    ...
    try:
        l2.append({
            'name': n2 % 'Home Continuous',
            'url': h['vod-continuous']['bitrate0'],
            'image': image})
    except:
        pass
    ...
    try:
        l2.append({
            'name': n2 % 'Home Condensed',
            'url': h['vod-condensed']['bitrate0'],
            'image': image})
    except:
        pass
    ...
    try:
        l1.append({
            'name': n1 % 'Away LIVE',
            'url': a['live']['bitrate0'] + selectAwayGame,
            'image': image})
    except:
        pass
    ...
    try:
        l2.append({
            'name': n2 % 'Away Continuous',
            'url': a['vod-continuous']['bitrate0'],
            'image': image})
    except:
        pass
    ...
    try:
        l2.append({
            'name': n2 % 'Away Condensed',
            'url': a['vod-condensed']['bitrate0'],
            'image': image})
    except:
        pass
    ...
    if finish == 'false':
        for i in l1:
            addDirectoryItem(i['name'], i['url'], 'nhlResolve', i['image'], '0', isFolder=False)
    else:
        for i in l2:
            addDirectoryItem(i['name'], i['url'], 'nhlResolve', i['image'], '0', isFolder=False)
