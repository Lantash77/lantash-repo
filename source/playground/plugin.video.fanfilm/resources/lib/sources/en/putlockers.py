...
class source:
    ...
    def episode(self, url, imdb, tvdb, title, premiered, season, episode):
        try:
            ...
            data = client.parseDOM(data, 'div', attrs={
                'id': 'details'})
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            r = client.parseDOM(r, 'div', {
                'class': 'server_line'})
            r = [(client.parseDOM(i, 'a', ret='href')[0], client.parseDOM(i, 'p', attrs={
                'class': 'server_servername'})[0]) for i in r]
            if r:
                for i in r:
                    try:
